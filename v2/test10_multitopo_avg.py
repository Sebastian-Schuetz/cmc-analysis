# -*- coding: utf-8 -*-
"""
Created on Mon Nov 15 11:01:42 2021
...
if __name__ == '__main__':
    ...
    plot_topomaps(np.mean(wcts_t, axis=0)[:, freq_of_int].T, freqs[freq_of_int], chansel, 5, 4, (0, 0.15), name="Shifted by " + str(i),
                  path = r"D:\Sebastian\Medizin\Doktorarbeit\Software\Github-Repos\cmc-analysis\plots\topo_maps\\" + str(i) + ".png")
    
    plot_coh_over_freq_welch(np.mean(wcts_t, axis=0)[chansel.index("C3"), :], freqs,
                             "C3", 0, 50, True)